...
const AddComment = ({ postId }: Props) => {
  ...
  return (
    <div className="mt-14">
      ...
      <form
        className="flex flex-col border dark:border-green-950 shadow-sm rounded px-8 pt-6 pb-6 mb-10"
      ...
      >
        ...
        <input
          className={`cursor-pointer bg-green-500 text-white rounded py-2 hover:bg-green-600 ${
